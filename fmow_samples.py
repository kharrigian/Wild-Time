...
if __name__ == '__main__':
    # datasets = pickle.load(open(os.path.join('./raw-data/', 'fmow.pkl'), 'rb'))
    # label_count = get_label_count('fmow', 62, datasets)
    # print(label_count)
    # datasets = pickle.load(open(os.path.join('./raw-data/', 'huffpost.pkl'), 'rb'))
    # label_count = get_label_count('huffpost', 11, datasets)
    # print(label_count)
    # datasets = pickle.load(open(os.path.join('./raw-data/', 'yearbook.pkl'), 'rb'))
    # label_count = get_label_count('yearbook', 2, datasets)
    # print(label_count)
    # datasets = pickle.load(open(os.path.join('./raw-data/', 'arxiv.pkl'), 'rb'))
    # label_count = get_label_count('arxiv', 172, datasets)
    # print(label_count)
    # datasets = pickle.load(open(os.path.join('./raw-data/', 'precipitation.pkl'), 'rb'))
    # label_count = get_label_count('precipitation', 9, datasets)
    # print(label_count)
    datasets = pickle.load(open(os.path.join('./raw-data/', 'mimic_preprocessed_mortality.pkl'), 'rb'))
    label_count = get_label_count('mimic', 2, datasets)
    print(label_count)
    print()
    datasets = pickle.load(open(os.path.join('./raw-data/', 'mimic_preprocessed_readmission.pkl'), 'rb'))
    label_count = get_label_count('mimic', 2, datasets)
    print(label_count)